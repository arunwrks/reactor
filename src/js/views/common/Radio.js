...
export default class Radio extends React.Component {
    ...
    static propTypes = {
    	name: React.PropTypes.string.required,// name for the radio, required property
	...
	render() { 
		...
		return ( 
			<div className={this.state.enabled ? "radio" + {this.props.inline ? "-inline" : ""} : {this.props.inline ? "radio-inline disabled" : "radio disabled"}}>
			  <label>
